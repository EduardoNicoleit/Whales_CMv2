<script lang="ts">
  ...
  const HEADER_TITLE = "Being the only source of life force which powers our whales, KRILL enables the whales to travel
across the solaxy and is rightfully owned by every HODL whale.";
